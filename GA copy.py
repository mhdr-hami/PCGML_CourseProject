import numpy as np
import Data_Pipeline_Test_copy as dpt
import sys
import os
import cv2
import glob
...
def main():
    ...
    mario_address = './mario maps'
    kidicarus_address = './kid maps'
    ...
    dataset_smb = []
    for map_name in os.listdir(mario_address):
        dataset_smb += dpt.dataset_creator(map_name, 'smb')
    
    dataset_kid = []
    for map_name in os.listdir(mario_address):
        dataset_kid += dpt.dataset_creator(kidicarus_address, 'kid')
